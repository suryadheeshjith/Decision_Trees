import numpy as np
from utils import get_xor, get_donut, entropy
...
class TreeNode:
        ...
        if len(Y) == 1 or len(set(Y)) == 1:
            ...
            if max_ig == 0:
                ...
                if self.depth == self.max_depth:
                    ...
                    #print("right_idx.shape:", right_idx.shape, "len(X):", len(X))
                    Xright = X[right_idx]
                    Yright = Y[right_idx]
    ...
    def find_split(self, X, Y, col):
        ...
        # To test below line of code, try boundary_test.py
    ...
    def predict_one(self, x):
        ...
        # This will correpond to the root attribute. Not the leaf.
